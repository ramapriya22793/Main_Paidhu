      ...
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 glass border-b border-gray-200/10 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => scrollToSection('home')}>
            <img 
              src="/paidhu_logo_white.png" 
              alt="Paidhu Group Logo" 
              className="h-8 w-auto object-contain brightness-0 dark:brightness-100 dark:invert" 
            />
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              return (
                <div key={idx} className="p-8 rounded-3xl bg-[#FFFFFF] dark:bg-dark border border-gray-200/10 text-center shadow-sm">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-semibold opacity-60">Registered Office</h4>
                    <p className="text-sm mt-1 opacity-85">Kashmir & Bengaluru, India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-xs uppercase tracking-wider font-semibold opacity-60">Phone Support</h4>
                    <p className="text-sm mt-1 opacity-85">+91 98765 43210</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1 opacity-85">info@paidhugroup.com</p>
                  </div>
                </div>
              </div>
            </div>
